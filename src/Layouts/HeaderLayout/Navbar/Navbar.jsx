        ...
        <Headroom>
            ...
            <section className='lg:px-5 px-2  bg-black w-full'>
                <div className='flex   h-16 justify-between items-center'>
                    <div>
                        <a href='#' className='lg:text-2xl text-3xl lg:-tracking-[-.1rem]'>safkat.<span className='text-[#EE264A]'>dev</span></a>
                    </div>
                    <div>
                        ...
                        <ul className={
                            open ? 'flex lg:flex-row lg:hidden text-center transition-all righ duration-700 h-[80vh]  bg-black space-y-5 text-[2em] absolute left-0 right-0  opacity-100 top-16 flex-col uppercase justify-center  lg:space-x-7 items-center' :
                                'flex lg:flex-row lg:hidden text-center bg-black h-[80vh] transition-all righ duration-700 space-y-5 text-[2em] absolute left-0 right-0 md:right-96 top-16 flex-col opacity-0 uppercase justify-center  lg:space-x-7 items-center'
                        }>
                            <li><a className="transition-all duration-700  lg:hover:px-2 lg:hover:tracking-widest" href="#">Home</a></li>
                            <li><a className="transition-all duration-700  lg:hover:px-2 hover:tracking-widest" href="#about">About</a></li>
                            <li><a className="transition-all duration-700  lg:hover:px-2 hover:tracking-widest" href="#projects">Projects</a></li>
